...
class ProfileController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $profiles = $em->getRepository('AppBundle:Profile')->findList();
     ...
     *
     * @Route("/new", name="backend_profile_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('backend_profile_show', array('slug' => $profile->getSlug()));
        }
     ...
     *
     * @Route("/{slug}", name="backend_profile_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{slug}/edit", name="backend_profile_edit")
     * @Method({"GET", "POST"})
     */
     ...
     *
     * @Route("/{id}", name="backend_profile_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Profile $profile)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('backend_profile_delete', array('id' => $profile->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }

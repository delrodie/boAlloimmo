...
class PartenaireController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('backend_partenaire_show', array('slug' => $partenaire->getSlug()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($partenaire); //dump($partenaire->getServices());die();
